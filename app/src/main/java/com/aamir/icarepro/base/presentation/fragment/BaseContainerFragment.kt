package com.aamir.icarepro.base.presentation.fragment
...
import com.aamir.icarepro.ui.activity.AuthenticationActivity
import com.aamir.icarepro.utils.isNetworkConnected
    ...
    fun handleError(errorModel: ErrorModel){
        lifecycleScope.launch {
            if(errorModel.status == Status.UNAUTHROZIED.name) {
                ...
                toast(errorModel.message ?: getString(R.string.something_went_wrong))
            } else
                toast(errorModel.message ?: getString(R.string.something_went_wrong))
        }
